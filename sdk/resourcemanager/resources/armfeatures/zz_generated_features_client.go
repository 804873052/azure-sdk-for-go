...
func NewFeaturesClient(con *arm.Connection, subscriptionID string) *FeaturesClient {
	return &FeaturesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *FeaturesClient) listAllHandleResponse(resp *http.Response) (FeaturesListAllResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.FeatureOperationsListResult); err != nil {
		return FeaturesListAllResponse{}, err
	}
	return result, nil
}
