...
// PricingTier - The policy pricing tier. Possible values are Advanced and Defender.
type PricingTier string

const (
	// PricingTierAdvanced - The pricing tier gives the user ability to use policy exemption feature.
	PricingTierAdvanced PricingTier = "Advanced"
	// PricingTierDefender - The pricing tier gives the user ability to use policy exemption feature. This pricing tier is managed by Azure Security Center.
...
// ProvisioningState - The provisioning state of the policy pricing resource.
type ProvisioningState string

const (
	// ProvisioningStateAccepted - When creating policy pricing at the management group level, the provisioning state will be accepted initially.
	ProvisioningStateAccepted ProvisioningState = "Accepted"
	// ProvisioningStateDeleting - When deleting policy pricing at the management group level, the provisioning state will be deleting.
	ProvisioningStateDeleting ProvisioningState = "Deleting"
	// ProvisioningStateSucceeded - The policy pricing is provisioned.
