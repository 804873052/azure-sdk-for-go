...
// PolicyPricingsCreateOrUpdatePollerResponse contains the response from method PolicyPricings.CreateOrUpdate.
type PolicyPricingsCreateOrUpdatePollerResponse struct {
	// Poller contains an initialized poller.
	Poller *PolicyPricingsCreateOrUpdatePoller
...
func (l PolicyPricingsCreateOrUpdatePollerResponse) PollUntilDone(ctx context.Context, freq time.Duration) (PolicyPricingsCreateOrUpdateResponse, error) {
	respType := PolicyPricingsCreateOrUpdateResponse{}
	resp, err := l.Poller.pt.PollUntilDone(ctx, freq, &respType.PolicyPricing)
	if err != nil {
		return respType, err
	}
...
// Resume rehydrates a PolicyPricingsCreateOrUpdatePollerResponse from the provided client and resume token.
func (l *PolicyPricingsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *PolicyPricingsClient, token string) error {
	pt, err := armruntime.NewPollerFromResumeToken("PolicyPricingsClient.CreateOrUpdate", token, client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &PolicyPricingsCreateOrUpdatePoller{
...
// PolicyPricingsCreateOrUpdateResponse contains the response from method PolicyPricings.CreateOrUpdate.
type PolicyPricingsCreateOrUpdateResponse struct {
	PolicyPricingsCreateOrUpdateResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// PolicyPricingsCreateOrUpdateResult contains the result from method PolicyPricings.CreateOrUpdate.
type PolicyPricingsCreateOrUpdateResult struct {
	PolicyPricing
}

// PolicyPricingsDeletePollerResponse contains the response from method PolicyPricings.Delete.
type PolicyPricingsDeletePollerResponse struct {
	// Poller contains an initialized poller.
	Poller *PolicyPricingsDeletePoller
...
// freq: the time to wait between intervals in absence of a Retry-After header. Allowed minimum is one second.
// A good starting value is 30 seconds. Note that some resources might benefit from a different value.
func (l PolicyPricingsDeletePollerResponse) PollUntilDone(ctx context.Context, freq time.Duration) (PolicyPricingsDeleteResponse, error) {
...
// Resume rehydrates a PolicyPricingsDeletePollerResponse from the provided client and resume token.
func (l *PolicyPricingsDeletePollerResponse) Resume(ctx context.Context, client *PolicyPricingsClient, token string) error {
	pt, err := armruntime.NewPollerFromResumeToken("PolicyPricingsClient.Delete", token, client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &PolicyPricingsDeletePoller{
...
// PolicyPricingsDeleteResponse contains the response from method PolicyPricings.Delete.
type PolicyPricingsDeleteResponse struct {
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// PolicyPricingsGetResponse contains the response from method PolicyPricings.Get.
type PolicyPricingsGetResponse struct {
	PolicyPricingsGetResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// PolicyPricingsGetResult contains the result from method PolicyPricings.Get.
type PolicyPricingsGetResult struct {
	PolicyPricing
}

// PolicyPricingsListForManagementGroupResponse contains the response from method PolicyPricings.ListForManagementGroup.
type PolicyPricingsListForManagementGroupResponse struct {
	PolicyPricingsListForManagementGroupResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// PolicyPricingsListForManagementGroupResult contains the result from method PolicyPricings.ListForManagementGroup.
type PolicyPricingsListForManagementGroupResult struct {
	PolicyPricingListResult
}

// PolicyPricingsListResponse contains the response from method PolicyPricings.List.
type PolicyPricingsListResponse struct {
	PolicyPricingsListResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// PolicyPricingsListResult contains the result from method PolicyPricings.List.
type PolicyPricingsListResult struct {
	PolicyPricingListResult
}
