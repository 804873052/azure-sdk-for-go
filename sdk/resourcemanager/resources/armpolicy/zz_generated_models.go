...
// PolicyPricing - The policy pricing.
type PolicyPricing struct {
	// REQUIRED; Properties for the policy pricing.
	Properties *PolicyPricingProperties `json:"properties,omitempty"`

	// READ-ONLY; The ID of the policy pricing.
	ID *string `json:"id,omitempty" azure:"ro"`

	// READ-ONLY; The name of the policy pricing.
	Name *string `json:"name,omitempty" azure:"ro"`

	// READ-ONLY; Azure Resource Manager metadata containing createdBy and modifiedBy information.
	SystemData *SystemData `json:"systemData,omitempty" azure:"ro"`

	// READ-ONLY; The type of the resource (Microsoft.Authorization/policyPricings).
	Type *string `json:"type,omitempty" azure:"ro"`
}

// PolicyPricingListResult - List of policy pricings.
type PolicyPricingListResult struct {
	// An array of policy pricings.
	Value []*PolicyPricing `json:"value,omitempty"`

	// READ-ONLY; The URL to use for getting the next set of results.
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`
}

// MarshalJSON implements the json.Marshaller interface for type PolicyPricingListResult.
func (p PolicyPricingListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "nextLink", p.NextLink)
	populate(objectMap, "value", p.Value)
	return json.Marshal(objectMap)
...
// PolicyPricingProperties - The policy pricing properties.
type PolicyPricingProperties struct {
	// REQUIRED; The policy pricing tier. Possible values are Advanced and Defender.
	PricingTier *PricingTier `json:"pricingTier,omitempty"`

	// READ-ONLY; The provisioning state of the policy pricing resource.
	ProvisioningState *ProvisioningState `json:"provisioningState,omitempty" azure:"ro"`
}

// PolicyPricingsBeginCreateOrUpdateOptions contains the optional parameters for the PolicyPricings.BeginCreateOrUpdate method.
type PolicyPricingsBeginCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// PolicyPricingsBeginDeleteOptions contains the optional parameters for the PolicyPricings.BeginDelete method.
type PolicyPricingsBeginDeleteOptions struct {
	// placeholder for future optional parameters
}

// PolicyPricingsGetOptions contains the optional parameters for the PolicyPricings.Get method.
type PolicyPricingsGetOptions struct {
	// placeholder for future optional parameters
}

// PolicyPricingsListForManagementGroupOptions contains the optional parameters for the PolicyPricings.ListForManagementGroup method.
type PolicyPricingsListForManagementGroupOptions struct {
	// placeholder for future optional parameters
}

// PolicyPricingsListOptions contains the optional parameters for the PolicyPricings.List method.
type PolicyPricingsListOptions struct {
	// placeholder for future optional parameters
}
